...
class CallbackData(object):
    ...
    def to_json_str(self):
        ...
        if len(s) > 64:
            raise ValueError(
                f"Length of serialized data is more than 64 character long: {s!r}"
            )  # you can try setting a different menu id or similar
        # end if
        return s
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}(type={self.type!r}, id={self.id!r}, value={self.value!r})"
...
class MenuData(object):
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}(message_id={self.message_id!r}, page={self.page!r}, data={self.data!r})"
...
class Data(object):
    ...
    def __init__(
        self, menus: Dict[str, JSONType] = None, history: List[str] = None, saved_data: Dict[str, JSONType] = None
    ):
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}(menus={self.menus!r}, history={self.history!r}saved_data={self.saved_data!r})"
